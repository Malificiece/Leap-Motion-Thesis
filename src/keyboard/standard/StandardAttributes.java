...
public class StandardAttributes extends KeyboardAttributes {
    private static final Point KEYBOARD_SIZE = new Point(742, 298);
    private static final Integer BORDER_SIZE = 2;
    ...
    private static final Point GAP_SIZE = new Point(2, 2);
    private static final Point KEY_SIZE = new Point(58, 58);
    private static final Point SPACE_KEY_SIZE = new Point(342, 58);
    private static final Point BACK_SPACE_KEY_SIZE = new Point(116, 58);
    private static final Point ENTER_KEY_SIZE = new Point(0, 0); //new Point(130, 58);
    private static final Point SHIFT_KEY_SIZE = new Point(100, 58);
    private static final int FIRST_ROW_OFFSET = 26;
    private static final int SECOND_ROW_OFFSET = 56;
    private static final int THIRD_ROW_OFFSET = 72;
    private static final int FOURTH_ROW_OFFSET = 0 + SHIFT_KEY_SIZE.x + GAP_SIZE.x; // REMOVE ME IF WE ADD BACK.
    private static final int FIFTH_ROW_OFFSET = 200;
